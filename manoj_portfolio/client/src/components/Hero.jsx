...
import { Linkedin, Github, MapPin, Star, Download } from 'lucide-react';
...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-blue-50 pt-20 pb-16 relative overflow-hidden">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }}
                transition={{ delay: 1 }}
                className="absolute bottom-4 right-4 sm:bottom-8 sm:right-8 bg-blue-600 p-2 sm:p-3 rounded-full shadow-lg"
              >
