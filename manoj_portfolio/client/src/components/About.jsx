    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            {/* Decorative Circles */}
            <div className="absolute -left-4 sm:-left-6 md:-left-10 -top-4 sm:-top-6 md:-top-10 w-16 sm:w-24 md:w-32 h-16 sm:h-24 md:h-32 bg-blue-200 rounded-full opacity-50"></div>
            <div className="absolute -left-2 sm:-left-3 md:-left-5 -top-2 sm:-top-3 md:-top-5 w-12 sm:w-16 md:w-24 h-12 sm:h-16 md:h-24 bg-blue-300 rounded-full opacity-50"></div>
            <div className="absolute left-0 top-0 w-10 sm:w-16 md:w-20 h-10 sm:h-16 md:h-20 bg-blue-400 rounded-full opacity-50"></div>
