...
import { Menu, X, Home, User, FolderKanban, Settings, MessageCircle, Linkedin, Github, ArrowRight } from 'lucide-react';
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed top-0 left-0 h-full w-72 bg-gradient-to-br from-white via-blue-50/40 to-white shadow-2xl z-[70] md:hidden flex flex-col border-r border-gray-200/30"
            >
